...
func (x *SignRequest) GetSidecar() *v1alpha1.BlobsSidecar {
	if x, ok := x.GetObject().(*SignRequest_Sidecar); ok {
		return x.Sidecar
	}
	return nil
}
...
type SignRequest_BlockV4 struct {
	BlockV4 *v1alpha1.BeaconBlockWithBlobKZGs `protobuf:"bytes,114,opt,name=blockV4,proto3,oneof"`
}

type SignRequest_Sidecar struct {
	Sidecar *v1alpha1.BlobsSidecar `protobuf:"bytes,115,opt,name=sidecar,proto3,oneof"`
}
...
func (*SignRequest_Sidecar) isSignRequest_Object() {}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x63, 0x4b, 0x65, 0x79, 0x73, 0x22, 0x93, 0x0c, 0x0a, 0x0b, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65,
	...
	0x52, 0x0c, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4a,
	0x0a, 0x07, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x34, 0x18, 0x72, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x6f, 0x63, 0x6b, 0x57, 0x69, 0x74, 0x68, 0x42, 0x6c, 0x6f, 0x62, 0x4b, 0x5a, 0x47, 0x73, 0x48,
	0x00, 0x52, 0x07, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x34, 0x12, 0x3f, 0x0a, 0x07, 0x73, 0x69,
	0x64, 0x65, 0x63, 0x61, 0x72, 0x18, 0x73, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x65, 0x74,
	0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x31, 0x2e, 0x42, 0x6c, 0x6f, 0x62, 0x73, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72,
	0x48, 0x00, 0x52, 0x07, 0x73, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x12, 0x68, 0x0a, 0x0c, 0x73,
	...
	0xce, 0x01, 0x0a, 0x22, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []interface{}{
	...
	(*v1alpha1.BeaconBlockWithBlobKZGs)(nil),      // 14: ethereum.eth.v1alpha1.BeaconBlockWithBlobKZGs
	(*v1alpha1.BlobsSidecar)(nil),                 // 15: ethereum.eth.v1alpha1.BlobsSidecar
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	14, // 10: ethereum.validator.accounts.v2.SignRequest.blockV4:type_name -> ethereum.eth.v1alpha1.BeaconBlockWithBlobKZGs
	15, // 11: ethereum.validator.accounts.v2.SignRequest.sidecar:type_name -> ethereum.eth.v1alpha1.BlobsSidecar
