...
const (
	...
	// RPCBlobsSidecarsTopicV1 defines the v1 topic for the blobs sidecars by range rpc method.
	RPCBlobsSidecarsTopicV1 = protocolPrefix + BlobsSidecarsByRangeMessageName + SchemaVersionV1
...
var RPCTopicMappings = map[string]interface{}{
	...
	RPCBlobsSidecarsTopicV1: new(pb.BlobsSidecarsByRangeRequest),
}
